...
<div id="formblock<?php  echo $bID; ?>" class="newsletterstyle ccm-block-type-form">
<?php  if ($success): ?>
...
<form enctype="multipart/form-data" class="form-stacked miniSurveyView" id="miniSurveyView<?php  echo $bID; ?>" method="post" action="<?php  echo $formAction ?>">
    ...
    <div class="fields">
        ...
        <script type="text/javascript">
            $(function(){
                $("#formblock<?php echo $bID?> .field-email input[type='email']").attr("placeholder", $.trim($("#formblock<?php echo $bID?> .control-label").text()));
            })
        </script>


        <div class="form-actions">
        <input type="submit" name="Submit" class="btn btn-default" value="<?php  echo h(t($survey->submitText)); ?>" />
    </div>
